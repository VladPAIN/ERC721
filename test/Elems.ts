...
describe('Farm contract', () => {
    ...
    describe("Mint", function () {
        ...
        it("Should mint without minter role", async function () {
            ...
            await expect(elems.connect(addr1).mintNFT(addr1.address, "link")).to.be.revertedWith('Caller is not a minter');
    ...
    describe("Burn", function () {
        ...
        it("Should burn without burner role", async function () {
            ...
            await expect(elems.connect(addr1).burnNFT(addr1.address, 1)).to.be.revertedWith('Caller is not a burner');
            
        });

        it("Should burn if you have burner role", async function () {

            await elems.grantRole("0x3c11d16cbaffd01df69ce1c404f6340ee057498f5f00246190ea54220576a848", addr1.address);
